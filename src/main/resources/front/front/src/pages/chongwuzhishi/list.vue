	...
	<div>
		...
		<div class="list-preview">
			...
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('chongwuzhishi','新增')" type="primary" @click="add('/index/chongwuzhishiAdd')">
					添加
				</el-button>
			</el-form>
			<div class="select2">
...
<script>
	export default {
		...
		methods: {
			...
			async getFenlei() {
				await this.$http.get('zhishifenlei/list',{params: {sort: 'zhishifenlei',order: 'desc'}}).then(res => {
					if (res.data.code == 0) {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`chongwuzhishi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/chongwuzhishiDetail', query: params});
			},
